...
resource "aws_iam_role" "codepipeline-go-app-service-role" {
    name = "codepipeline-go-app-service-role"
    assume_role_policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_policy" "codepipeline-base-policy-for-go-app" {
  name        = "CodePipelineBasePolicyForGoApp"
  path        = "/"
  description = "CodePipeline base policy for go-app project"
...
resource "aws_iam_role_policy_attachment" "codepipeline-go-app-base-access" {
  role       = "${aws_iam_role.codepipeline-go-app-service-role.name}"
  policy_arn = "${aws_iam_policy.codepipeline-base-policy-for-go-app.arn}"
}